                        ...
                        <form action="{{ route('grupo.store') }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select rounded-0" name="list1">
                                                <option>Ativo</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="list2" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Lista 3:</label>
                                            <input type="text" class="form-control" name="list3" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Exibir o dashboard do consultor</label>
                                            <select class="custom-select rounded-0" name="exibircons">
                                                <option>Sim</option>
                                                <option>Não</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Exibir o relatoria de parcelas do consultor
                                                3:</label>
                                            <input type="text" class="form-control" name="exibirparc" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Permite baixar manual de parcelas</label>
                                            <select class="custom-select rounded-0" name="manual">
                                                <option>Sim</option>
                                                <option>Não</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select rounded-0" name="tipocomissao">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select rounded-0" name="Percenteualcomissao">
                                                <option>0,5%</option>
                                                <option>1%</option>
                                                <option>2%</option>
                                                <option>3%</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Permite gerar recibo de parcela de
                                                acordo</label>
                                            <select class="custom-select rounded-0" name="recibo">
                                                <option>Sobre o valor total recuperado</option>
                                                <option>Sobre o valor total de honorários</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" data-val="true"
                                                ...
                                                <option value="2">Reagendamentos de hoje, ontem e antes de ontem
                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <font color="red"><span class="field-validation-valid"
                                                        ...
                                                        data-valmsg-replace="true"></span></font>
                                                <span id="" class="help-block" style="font-size: 11px">Escolha
                                                    Sim
                                                    para
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="u_fname" class="control-label col-sm-12">*Permite pesquisar
                                                devedores
                                                por situação</label>
                                            <div class="col-sm-12">
                                                ...
                                                <font color="red"><span class="field-validation-valid"
                                                        ...
                                                        data-valmsg-replace="true"></span></font>
                                                <span id="" style="font-size: 11px" class="help-block">Escolha
                                                    Sim
                                                    para
                                                    permitir que os consultores deste grupo de consultores possam pesquisar
                                                    devedores por situação (ativo ou inativo). Escolha Não para permitir
                                                    somente
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="u_fname" class="control-label col-sm-12">*Permite upload de
                                                boleto
                                                manual</label>
                                            <div class="col-sm-12">
                                                <select class="form-control"
                                                    id="permite_upload_boleto_manual_como_consultor"
                                                ...
                                                <span id="helpPermiteUpload" class="help-block"
                                                    ...
                                                    os consultores deste grupo de consultores possam fazer o upload de
                                                    boletos
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <span id="helpPermiteUpload" class="help-block"
                                                    ...
                                                    atribuído automaticamente para os consultores deste grupo de consultores
                                                    em
                                                    reagendamento feitos por meio do botão Reagendar, presente na tela de
                                                    negociações do devedor. O botão Reagendar somente será exibido se houver
                                                    um
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="u_fname" class="control-label col-sm-12">Permite reagendamento
                                                para
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <span id="helpPermiteReagendamentoOutros" class="help-block"
                                                    ...
                                                    permitir que consultores deste grupo possam selecionar o nome do
                                                    consultor
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="u_fname" class="control-label col-sm-12">Exibir relatório
                                                financeiro
                                                do consultor</label>
                                            <div class="col-sm-12">
                                                ...
                                                <span id="helpExibirRelFinanceiro" class="help-block"
                                                    style="font-size: 11px">Escolha Sim para
                                                    permitir que os consultores deste grupo de consultores possam visualizar
                                                    o
                                                    relatório financeiro de acordos feitos pelo consultor logado. O
                                                    relatório
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <span id="helpHabCadDevDiv" class="help-block"
                                                    style="font-size: 11px">Escolha Sim para permitir que
                                                    os consultores deste grupo cadastrem novos devedores e dívidas. Isso
                                                    pode
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <span id="helpVisDashDevedor" class="help-block"
                                                    style="font-size: 11px">Escolha Sim para permitir que
                                                    os consultores deste grupo visualizem o dashboard dos devedores. Escolha
                                                    Não
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <font color="red"><span class="field-validation-valid"
                                                        data-valmsg-for="situacao" data-valmsg-replace="true"></span>
                                                </font>
                                                <span id="helpSituacao" class="help-block"
                                                    style="font-size: 11px">Situação
                                                    do grupo de consultores.
                                                    Somente grupos ativos poderão ser associados aos novos
                                                    consultores.</span>
                                            </div>
                                        </div>
                                    </div>
